...
from .models import Category, Movie, Actor, Genre, MovieShort, RatingStar, Rating, Reviews
from ckeditor_uploader.widgets import CKEditorUploadingWidget
from modeltranslation.admin import TranslationAdmin


class MovieAdminForm(forms.ModelForm):
    description_ru = forms.CharField(label="Описание на русском", widget=CKEditorUploadingWidget())
    description_en = forms.CharField(label="Описание на английском", widget=CKEditorUploadingWidget())
