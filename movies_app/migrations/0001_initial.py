    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_country', models.PositiveIntegerField(default=0, help_text='указать сумму в доллорах', verbose_name='Местные сборы')),
                ...
                ('actor', models.ManyToManyField(related_name='film_actor', to='movies_app.Actor', verbose_name='актер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies_app.RetingStar', verbose_name='звезда')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Описание')),
                ('image', models.ImageField(upload_to='movie_short/', verbose_name='Изображение')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies_app.Movie', verbose_name='Фильм')),
            ],
            options={
